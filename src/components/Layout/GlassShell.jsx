        ...
        <div className="mx-auto max-w-[1200px] px-6 pt-7">
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <Link
                to="/"
                className="inline-flex items-center gap-2 rounded-full px-4 py-2 bg-[rgba(26,24,20,0.55)] border border-[rgba(212,197,169,0.14)] text-sand-light no-underline transition-all duration-300 hover:border-[rgba(164,184,107,0.45)] hover:bg-[rgba(74,90,42,0.22)]"
              >
              ...
              <Link
                to="/shop"
                className="hidden sm:inline-flex items-center gap-2 rounded-full px-4 py-2 bg-[rgba(26,24,20,0.35)] border border-[rgba(212,197,169,0.10)] text-sand-light no-underline transition-all duration-300 hover:border-[rgba(164,184,107,0.40)] hover:bg-[rgba(74,90,42,0.18)]"
                aria-label="المتجر"
              >
            ...
            <div className="flex items-center gap-2">
              ...
              <Link
                to="/shop/account"
                className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-[rgba(26,24,20,0.35)] border border-[rgba(212,197,169,0.10)] text-sand-light transition-all duration-300 hover:border-[rgba(164,184,107,0.40)] hover:bg-[rgba(74,90,42,0.18)]"
                aria-label="الحساب"
              >
