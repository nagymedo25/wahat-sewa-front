            ...
            <div className="space-y-3 col-span-2 sm:col-span-1">
              ...
              <div className="flex items-center gap-3">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="w-9 h-9 rounded-full flex items-center justify-center border border-[rgba(220,199,161,0.2)] bg-[rgba(255,255,255,0.05)] text-[var(--desert-sand)] hover:text-white hover:border-[var(--siwa-earth)] hover:bg-[var(--siwa-earth)]/30 transition-all hover:scale-110"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="w-9 h-9 rounded-full flex items-center justify-center border border-[rgba(220,199,161,0.2)] bg-[rgba(255,255,255,0.05)] text-[var(--desert-sand)] hover:text-white hover:border-[var(--palm-shade)] hover:bg-[var(--palm-shade)]/30 transition-all hover:scale-110"
                  aria-label="WhatsApp"
                  title="WhatsApp"
                >
                  <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
