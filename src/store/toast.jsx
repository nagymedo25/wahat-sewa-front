...
const toastConfig = {
  success: {
    icon: CheckCircle2,
    border: 'border-[rgba(164,184,107,0.40)]',
    bg: 'bg-[rgba(26,24,20,0.88)]',
    glow: 'shadow-[0_0_30px_rgba(164,184,107,0.12)]',
    iconColor: 'text-olive-glow',
    bar: 'bg-olive-glow',
  },
  error: {
    icon: AlertCircle,
    border: 'border-[rgba(232,168,124,0.40)]',
    bg: 'bg-[rgba(26,24,20,0.90)]',
    glow: 'shadow-[0_0_30px_rgba(232,168,124,0.12)]',
    iconColor: 'text-sunset',
    bar: 'bg-sunset',
  },
  warning: {
    icon: AlertTriangle,
    border: 'border-[rgba(212,197,169,0.40)]',
    bg: 'bg-[rgba(26,24,20,0.90)]',
    glow: 'shadow-[0_0_30px_rgba(212,197,169,0.12)]',
    iconColor: 'text-sand-light',
    bar: 'bg-sand-light',
  },
  info: {
    icon: Sparkles,
    border: 'border-[rgba(212,197,169,0.25)]',
    bg: 'bg-[rgba(26,24,20,0.88)]',
    glow: 'shadow-[0_0_30px_rgba(164,184,107,0.08)]',
    iconColor: 'text-olive-glow',
    bar: 'bg-olive-glow',
  },
};
